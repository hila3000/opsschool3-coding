...
def local_weather_output_to_file(current_city, current_country):
    weather_request_data, weather_temperature = weather_info(current_city)
    ...
    with open("{}weather_in_{}.txt".format("", current_city), "w") as text_file:
        ...
        print(
            "The weather in {}, {}: {} with temperature of {} Celsius degrees".format(current_city, current_country,
                                                                                      weather_description,
...
def check_weather_in_listed_cities(worldwide_cities):
    for city in worldwide_cities:
        weather_request_data, weather_temperature = weather_info(city)
