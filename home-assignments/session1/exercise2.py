...
with open("{}weather_in_{}.txt".format("", my_city), "w") as text_file:  # Writes the weather info in my city to file
    print("Want to know what's the weather in", my_city, "? Go to the text file created!")
    print("The weather in {}, {}: {} with temperature of {} Celsius degrees".format(my_city, my_country, weather_description,
                                                                                    int(weather_temperature)), file=text_file)
